...
export default class TokenInfo extends React.Component {
  ...
  render() {
    ...
    const phaseBlock =
      [ <p><b>Privatesale is not yet started.</b> Please check this page later.</p>
      , <div>
          <p><b>Privatesale is in progress.</b> You can buy some tokens here.</p>
      ...
      , <p><b>Privatesale is paused.</b> Please come back later.</p>
      , <p><b>Privatesale is over.</b> You can now migrate your tokens.</p>
      , <p><b>Privatesale is over.</b> Migration is over too.</p>
      ];
