...
export default class App extends React.Component {
  ...
  _onActionSetEscrow = value => {
    const {tokenInfo} = this.state;
    API.SetEscrow(tokenInfo.tokenManager.address, value )
      .then(this._notifyTransaction)
  }
  ...
  _setCrowdsaleManager = crowdsaleAddress => {
    const {tokenInfo} = this.state;
    API.setCrowdsaleManager(tokenInfo.address, tokenInfo.tokenManager.address, crowdsaleAddress )
      .then(this._notifyTransaction)
  }
            ...
            <Tabs>
              ...
              <Tab label="Actions" value="actions">
                <TokenActions
                  ...
                  onCrowdsaleAddress={this._setCrowdsaleManager}
                  onSetEscrow={this._onActionSetEscrow}
                />
              </Tab>
            </Tabs>
          }
